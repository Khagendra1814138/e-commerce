...
export const  TrendingProductsSideFilter = () =>{
    ...
    const FilterTrendingCreps = TrendingCreps.filter(filteredCreps => {
    ...
    return (
        <section className="productDisplayFrame">
            ...
            <div className="ProductDisplay"> {FilterTrendingCreps.map((product) => (
